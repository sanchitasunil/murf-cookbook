...
Called when patient requests a human or Matthew cannot resolve the query.
"""
...
async def transfer_to_human(
    ...
    - The query is a medical question Matthew cannot answer
    - The patient has complained or is frustrated after two attempts
    - The patient has asked for something outside Matthew's scope after one redirect
    Do NOT call this for routine bookings, FAQs, or cancellations Matthew can handle.
